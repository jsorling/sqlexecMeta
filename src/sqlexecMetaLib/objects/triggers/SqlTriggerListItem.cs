...
public record SqlTriggerListItem(string Name, int Object_id, byte Parent_class, string? Parent_class_desc, int Parent_id
   ...
   , string DBName, SqlGroupFlags GroupFlag, string Group
) : SqlExecBaseResult, ISqlItem
{
